...
public:
  ...
  {
    bool operator() (const std::vector<uint32_t> &a, const std::vector<uint32_t> &b) {
  ...
  std::map<std::vector<uint32_t>,uint32_t,CompareVecInt> poss_perms;
  std::map<std::vector<uint32_t>,uint32_t,CompareVecInt>::const_iterator poss_perms_iterator;
