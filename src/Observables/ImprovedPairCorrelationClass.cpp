#include "ImprovedPairCorrelationClass.h"

void ImprovedPairCorrelation::Init(Input &in)
{
...
void ImprovedPairCorrelation::Reset()
{
  nMeasure = 0;
  gr.y.zeros();
}

void ImprovedPairCorrelation::Accumulate()
{
  path.SetMode(1);
...
void ImprovedPairCorrelation::Write()
{
  if (nMeasure > 0) {
